...
class WC_Correios_Tracking_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->title            = __( 'Correios Tracking Code', 'correios-for-woocommerce' );
		$this->customer_email   = true;
		$this->description      = __( 'This email is sent when configured a tracking code within an order.', 'correios-for-woocommerce' );
		$this->heading          = __( 'Your order has been sent', 'correios-for-woocommerce' );
		$this->subject          = __( '[{site_title}] Your order {order_number} has been sent by Correios', 'correios-for-woocommerce' );
		$this->message          = __( 'Hi there. Your recent order on {site_title} has been sent by Correios.', 'correios-for-woocommerce' )
									. PHP_EOL . ' ' . PHP_EOL
									. __( 'To track your delivery, use the following the tracking code(s): {tracking_code}', 'correios-for-woocommerce' )
									. PHP_EOL . ' ' . PHP_EOL
									. __( 'The delivery service is the responsibility of the Correios, but if you have any questions, please contact us.', 'correios-for-woocommerce' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled' => array(
				...
				'type'    => 'checkbox',
				'label'   => __( 'Enable this email notification', 'correios-for-woocommerce' ),
				'default' => 'yes',
			),
			'subject' => array(
				'title'       => __( 'Subject', 'correios-for-woocommerce' ),
				'type'        => 'text',
				'description' => sprintf( __( 'This controls the email subject line. Leave blank to use the default subject: <code>%s</code>.', 'correios-for-woocommerce' ), $this->subject ),
				'placeholder' => $this->subject,
				'default'     => '',
				'desc_tip'    => true,
			),
			'heading' => array(
				'title'       => __( 'Email Heading', 'correios-for-woocommerce' ),
				'type'        => 'text',
				'description' => sprintf( __( 'This controls the main heading contained within the email. Leave blank to use the default heading: <code>%s</code>.', 'correios-for-woocommerce' ), $this->heading ),
				'placeholder' => $this->heading,
				'default'     => '',
				'desc_tip'    => true,
			),
			'tracking_message' => array(
				'title'       => __( 'Email Content', 'correios-for-woocommerce' ),
				'type'        => 'textarea',
				'description' => sprintf( __( 'This controls the initial content of the email. Leave blank to use the default content: <code>%s</code>.', 'correios-for-woocommerce' ), $this->message ),
				'placeholder' => $this->message,
				'default'     => '',
				'desc_tip'    => true,
			),
			'email_type' => array(
				'title'       => __( 'Email type', 'correios-for-woocommerce' ),
				'type'        => 'select',
				'description' => __( 'Choose which format of email to send.', 'correios-for-woocommerce' ),
				'default'     => 'html',
	...
	protected function get_custom_email_type_options() {
		...
		$types = array( 'plain' => __( 'Plain text', 'correios-for-woocommerce' ) );

		if ( class_exists( 'DOMDocument' ) ) {
			$types['html']      = __( 'HTML', 'correios-for-woocommerce' );
			$types['multipart'] = __( 'Multipart', 'correios-for-woocommerce' );
		}
